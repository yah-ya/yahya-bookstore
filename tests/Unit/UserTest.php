...
use Yahyya\taskmanager\App\Http\Requests\UpdateBook;
use Yahyya\taskmanager\App\Models\Book;
use Yahyya\taskmanager\App\Models\Task;
use Yahyya\taskmanager\App\Models\Author;
use Yahyya\taskmanager\App\Repositories\BookRepository;
...
class UserTest extends TestCase
{
    ...
    {
        $task = factory(Task::class)->create();
        $labels = factory(Book::class,5)->create();
    ...
    public function test_user_can_get_list_of_tasks_assigned_to_a_label()
    {
        ...
        $labels = factory(Book::class,5)->create();
        $newLabels = factory(Book::class,5)->create();
        ...
        $this->assertEquals(( Book::find($labels[0]))->tasks()->count(),1);
        $this->taskRepo->addLabels($newTask,$labels);
        $this->assertEquals(( Book::find($labels[0]))->tasks()->count(),2);
    ...
    public function test_user_able_to_get_task_details()
    {
        ...
        $users = factory(Author::class,3)->create();
        $task = factory(Task::class)->create();
        $request = new Request();
    ...
    function test_an_event_is_emitted_when_task_status_closed()
    {
        ...
        Event::assertDispatched(BookIsAssignedToAnAuthor::class, function ($event) use ($task) {
