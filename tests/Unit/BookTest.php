...
use Yahyya\bookstore\App\Http\Controllers\AuthorController;
...
use Tests\TestCase;
use Yahyya\bookstore\App\Http\Controllers\ReserveController;
...
class BookTest extends TestCase
{
    ...
    private $reserveController = null;
    public function setUp(): void
    {
        ...
        $this->reserveController = new ReserveController(new ReserveRepository());
    ...
    public function test_user_can_reserve_a_book()
    {
        $this->seed(DatabaseSeeder::class);
//        $this->request->merge();
        $req = $this->reserveController->reserve(Book::find( $this->bookController->index()[rand(0,100)]->id),$this->request);
    ...
    public function test_user_can_get_authors_list()
    {
        $this->seed(DatabaseSeeder::class);
        $authorController = new AuthorController(new AuthorRepository());

        $this->assertEquals($authorController->index()->getStatusCode(),200);
//        print_r($authorController->index()->getContent());
    }
